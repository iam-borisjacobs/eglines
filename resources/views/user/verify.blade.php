...
@section('content')
<div class="container-fluid py-4" id="kyc-status-wrapper">
    <!-- Breadcrumb & Header -->
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h3 class="f-w-800 kyc-status-title mb-1">Identity Verification</h3>
            <p class="kyc-status-subtitle f-13 mb-0">Compliance, KYC status, and security verification details</p>
        </div>
        <div>
            ...
            @if (Auth::user()->account_verify == 'Verified')
                ...
                <div class="card kyc-status-card mb-4">
                    <div class="card-body p-4 p-md-5 text-center">
                        ...
                        <h4 class="f-w-800 kyc-status-title mb-2">Identity Verification Completed</h4>
                        <p class="kyc-status-subtitle f-14 mb-4 mx-auto" style="max-width: 500px;">
                            Your trading account has met all regulatory requirements and is fully verified under international KYC / AML standards.
                        </p>

                        <div class="p-3 rounded-3 mb-4 text-start border kyc-info-box">
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <small class="kyc-status-subtitle f-11 text-uppercase f-w-700 d-block">Account Holder</small>
                                    <span class="f-w-700 kyc-status-title f-14">{{ Auth::user()->name }}</span>
                                </div>
                                <div class="col-sm-6">
                                    <small class="kyc-status-subtitle f-11 text-uppercase f-w-700 d-block">Registered Email</small>
                                    <span class="f-w-700 kyc-status-title f-14">{{ Auth::user()->email }}</span>
                                </div>
                                <div class="col-sm-6">
                                    <small class="kyc-status-subtitle f-11 text-uppercase f-w-700 d-block">Verification Status</small>
                                ...
                                <div class="col-sm-6">
                                    <small class="kyc-status-subtitle f-11 text-uppercase f-w-700 d-block">Trading & Limit Tier</small>
                        ...
                        <div class="text-start mb-4 p-3 rounded-3 border kyc-unlocked-box">
                            <h6 class="f-w-700 kyc-status-title mb-3 f-13 text-uppercase" style="letter-spacing: 0.04em;">
                                <i class="fa-solid fa-circle-nodes text-primary me-2"></i> Enabled Features on Your Account
                            </h6>
                            <div class="row g-2">
                                <div class="col-sm-6 d-flex align-items-center gap-2 f-13 kyc-status-subtitle">
            ...
            @elseif (Auth::user()->account_verify == 'Under review')
                ...
                <div class="card kyc-status-card mb-4">
                    <div class="card-body p-4 p-md-5 text-center">
                        ...
                        <h4 class="f-w-800 kyc-status-title mb-2">KYC Application Under Review</h4>
                        <p class="kyc-status-subtitle f-14 mb-4 mx-auto" style="max-width: 500px;">
            ...
            @else
                ...
                <div class="card kyc-status-card mb-4">
                    <div class="card-body p-4 p-md-5 text-center">
                        ...
                        <h4 class="f-w-800 kyc-status-title mb-2">Begin Your Identity Verification</h4>
                        <p class="kyc-status-subtitle f-14 mb-4 mx-auto" style="max-width: 520px;">
                        ...
                        <div class="row g-3 mb-4 text-start">
                            <div class="col-md-4">
                                <div class="p-3 border rounded-3 text-center h-100 kyc-step-card">
                                    <div class="f-w-800 text-primary f-18 mb-1">01</div>
                                    <div class="f-w-700 kyc-status-title f-13 mb-1">Personal Details</div>
                                    <small class="kyc-status-subtitle f-11">Provide legal name, address & phone number</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="p-3 border rounded-3 text-center h-100 kyc-step-card">
                                    <div class="f-w-800 text-primary f-18 mb-1">02</div>
                                    <div class="f-w-700 kyc-status-title f-13 mb-1">Government ID</div>
                                    <small class="kyc-status-subtitle f-11">Upload photo of Passport, Driver's License or ID</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="p-3 border rounded-3 text-center h-100 kyc-step-card">
                                    <div class="f-w-800 text-primary f-18 mb-1">03</div>
                                    <div class="f-w-700 kyc-status-title f-13 mb-1">Instant Activation</div>
                                    <small class="kyc-status-subtitle f-11">Fast review by compliance system</small>
                                </div>
                            </div>
                        </div>

                        <div>
                            <a href="{{ route('kycform') }}" class="btn btn-primary rounded-pill px-4 py-2.5 f-14 f-w-700 shadow-sm">
            ...
            <div class="card kyc-status-card">
                <div class="card-body p-4 d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h6 class="f-w-700 kyc-status-title mb-0 f-14">Need Assistance with Verification?</h6>
                            <small class="kyc-status-subtitle f-12">Our compliance and security team is available 24/7 to assist you.</small>
                        </div>
                    </div>
                    <div>
...
body.dark-only .kyc-status-card {
...
body.dark-only .kyc-status-title {
...
body.dark-only .kyc-status-subtitle {
...
body.dark-only .kyc-unlocked-box {
